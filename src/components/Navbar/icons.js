...
const NotificationIcon = () => {
  return (
    <div className="relative inline-block">
      ...
      <span className="absolute top-1 right-1 inline-flex items-center justify-center px-[5px] py-[3px] text-[10px] font-bold leading-none text-white transform translate-x-1/2 -translate-y-1/2 bg-red-600 rounded-full">
        3
      </span>
    </div>
  );
